...
| **Placement**        | Fullscreen indicator hoisted to `<body>` (`appendTo`, default `'body'`) |       ❌        |
|                      | Hoisting disabled (`[appendTo]="null"`)                                 |       ❌        |
|                      | Hoisted to a custom overlay root (`appendTo="#overlay-root"`)           |       ❌        |
